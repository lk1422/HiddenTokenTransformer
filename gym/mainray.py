...
from arithmetic_gyms import additionEOSHiddenStep as cur_gym
...
config = (
    ...
    #             "lstm": True,
    #             # "use_attention": True,
    #             # "attention_num_heads": 2,  # Optional: Number of attention heads
    #             # "attention_dim": 64,       # Optional: Dimension of attention embeddings
    #         }
    #     )
)
